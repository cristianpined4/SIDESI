    ...
    <main>
        <section class="relative overflow-hidden bg-gradient-to-br from-background via-card to-secondary/20">
            <div class="container mx-auto px-4 py-24 lg:py-32">
                ...
                <div class="space-y-8">
                    <div class="space-y-4">
                    <h1 class="text-4xl lg:text-6xl font-bold text-balance leading-tight">Sistema de Desarrollo de <span
                        class="text-primary">Estudiantes de Ingeniería</span>
                    </h1>
                    <p class="text-xl text-muted-foreground text-pretty leading-relaxed">Plataforma integral para la gestión
                        académica, eventos, desarrollo profesional y comunicación institucional de la comunidad estudiantil de
                        ingeniería.
                    </p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4">
                    <button data-slot="button"
                        class="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*=&#x27;size-&#x27;])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-10 rounded-md px-6 has-[&gt;svg]:px-4 text-base">Explorar
                        Eventos<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="text-center">
                        <div class="h-12 w-12 mx-auto mb-3 rounded-lg bg-primary/10 flex items-center justify-center">
                ...
                <div class="relative">
                    ...
                    <div class="h-full w-full rounded-xl bg-card shadow-2xl flex items-center justify-center">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-muted-foreground text-sm">Accede a todos los servicios y recursos académicos</p>
                        </div>
                        </div>
                    </div>
                    </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto">Descubre todas las funcionalidades
            ...
            <div data-slot="card"
                ...
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Organiza y
                    participa en talleres, conferencias y actividades académicas con inscripción automática.</div>
                </div>
            </div>
            <div data-slot="card"
                class="bg-card text-card-foreground flex flex-col gap-6 rounded-xl py-6 border-0 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Accede a
            ...
            <div data-slot="card"
                ...
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Conecta con
            ...
            <div data-slot="card"
                ...
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Realiza pagos
            ...
            <div data-slot="card"
                ...
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Encuentra
        ...
        <div class="container mx-auto px-4">
            ...
            <div data-slot="card"
                ...
                <div data-slot="card-title" class="font-semibold text-2xl text-balance">Convocatoria Abierta: Congreso
                    Nacional de Ingeniería 2024</div>
                </div>
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Se abre la
                    convocatoria para participar en el evento más importante del año con ponencias magistrales y talleres
                    especializados.</div>
                </div>
            </div>
            <div data-slot="card"
                ...
                <div data-slot="card-title" class="font-semibold text-xl text-balance">Nuevos Cursos de Certificación
                    Profesional</div>
                </div>
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Amplía tus
            ...
            <div data-slot="card"
                ...
                <div data-slot="card-title" class="font-semibold text-xl text-balance">Bolsa de Empleo: Oportunidades
                    para Egresados</div>
                </div>
                <div data-slot="card-content" class="px-6">
                <div data-slot="card-description" class="text-muted-foreground text-base leading-relaxed">Nuevas ofertas
