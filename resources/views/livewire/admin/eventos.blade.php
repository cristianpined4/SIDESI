    ...
    <main style="width: 100%;">
        ...
        <div id="Sesion-modal" class="modal" wire:ignore.self>
            <div
                class="modal-dialog modal-dialog-centered modal-dialog-scrollable flex justify-center items-center"
                style="max-width: 80%;">
                <div class="modal-content w-full max-w-[1100px] h-[80vh] flex flex-col rounded-xl shadow-lg overflow-hidden">

                    <!-- Header -->
                    <div class="modal-header bg-gradient-to-r text-white flex justify-between items-center">
                        <h5 class="modal-title text-lg font-semibold">Gestión de Sesiones</h5>
                        <button
                            type="button"
