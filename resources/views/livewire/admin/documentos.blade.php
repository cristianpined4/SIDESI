...
<main style="width: 100%;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="userLabel">{{ $record_id ? 'Editar documento' : 'Nuevo documento' }}
                    </h5>
                ...
                <div class="modal-body">
                    <div class="form-group mb-2">
                        ...
                        <input wire:model="fields.title" type="text" placeholder="Nombre del documento"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select wire:model="fields.visibility"
                            class="form-control @error('fields.visibility') was-validated is-invalid @enderror">
    ...
    <div class="flex justify-between items-end flex-wrap gap-4">
        <div class="flex items-start gap-4 flex-col" style="max-width: 800px;width: 100%;">
            ...
            <input type="text" placeholder="Buscar documento..." class="form-input"
                wire:model.live.debounce.500ms="search">
        </div>
        <button class="btn btn-primary" style="max-width: 200px;" wire:click="abrirModal('modal-home')">Nuevo
            Documento</button>
    </div>
        ...
        <table class="table w-full bg-white border border-gray-200 rounded-lg shadow-sm table-fixed">
            ...
            <tbody class="text-gray-700 text-sm">
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">{{ $doc->created_at->format('d/m/Y h:i A') }}</td>
                    <td class="px-4 py-3 flex space-x-2 justify-center items-center whitespace-nowrap text-center">
                        <button
                            ...
                            wire:click="edit('{{ $doc->id }}')">Editar</button>
                        <button
                            class="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600 transition text-sm cursor-pointer"
                            onclick="confirmarEliminar({{ $doc->id }})">Eliminar</button>
                        <a class="bg-green-500 text-white px-3 py-1 rounded-md hover:bg-green-600 transition text-sm cursor-pointer"
                            style="max-width: 200px;" href="{{ asset($doc->path) }}" target="_blank">Ver</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
