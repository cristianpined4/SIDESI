    ...
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-10 text-center">
        ...
        <p class="mt-3 text-base text-zinc-600">
          ¿Ya tienes cuenta?
          <a href="{{ route('login') }}" class="font-medium text-sky-600 hover:text-sky-700 transition-colors">Iniciar
            sesión</a>
        </p>
      </div>
      ...
      <form class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <input id="name" type="text" placeholder="Nombre" wire:model="fields.name"
              onkeyup="this.value=this.value.replace(/[^a-zA-Z\sÁÉÍÓÚáéíóúÑñ]/g,'');" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
          ...
          <div>
            ...
            <input id="lastname" type="text" placeholder="Apellido" wire:model="fields.lastname"
              onkeyup="this.value=this.value.replace(/[^a-zA-Z\sÁÉÍÓÚáéíóúÑñ]/g,'');" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                          transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
        ...
        <div>
          ...
          <input id="username" type="text" placeholder="Nombre de usuario" wire:model="fields.username"
            onkeyup="this.value=this.value.toLowerCase();" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                        transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
        ...
        <div>
          ...
          <input id="email" type="email" placeholder="Correo electrónico" wire:model="fields.email"
            onkeyup="this.value=this.value.toLowerCase();" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                        transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <input id="password" type="password" placeholder="Contraseña" wire:model="fields.password" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                          transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
          ...
          <div>
            <label for="password_confirmation" class="block text-sm font-medium text-zinc-700 mb-2">Confirmar
              contraseña</label>
            <input id="password_confirmation" type="password" placeholder="Confirmar contraseña"
              wire:model="fields.password_confirmation" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                          transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
        ...
        <div>
          ...
          <input id="phone" type="text" placeholder="Teléfono" wire:model="fields.phone"
            onkeypress="return /[0-9]/.test(String.fromCharCode(event.which || event.keyCode));" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                        transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <select id="role_id" wire:model="fields.role_id" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base
                           transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
          ...
          <div id="institutionDiv" class="hidden">
            ...
            <input id="institution" type="text" placeholder="Institución" list="universidades"
              wire:model="fields.institution" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base placeholder-zinc-400
                          transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <select id="document_type" wire:model="fields.document_type" class="w-full h-12 rounded-xl border border-zinc-200 bg-white px-4 text-zinc-900 text-base
                           transition-colors focus:outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100
