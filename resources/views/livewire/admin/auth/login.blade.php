    ...
    <div class="w-full max-w-lg">
      ...
      <div class="mb-10 text-center">
        ...
        <p class="mt-3 text-base text-zinc-600">
          ...
          <a href="{{ route('register') }}" class="font-medium text-sky-600 hover:text-sky-700 transition-colors">Crear cuenta</a>
        </p>
      </div>
      ...
      <form onsubmit="login(event)" class="space-y-6">
        <div>
          ...
          <input id="loginEmail" type="text" placeholder="usuario o correo"
            wire:model="username"
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            @if(Route::has('password.request'))
              <a href="{{ route('password.request') }}" class="text-sm text-sky-600 hover:text-sky-700 transition-colors">¿Olvidaste tu contraseña?</a>
            @endif
          </div>
