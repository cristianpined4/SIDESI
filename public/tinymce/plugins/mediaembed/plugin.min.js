...
!(function () {
  ...
  const e = Object.getPrototypeOf,
    ...
    r = e => r =>
      (e => {
        ...
        return null === e
          ? 'null'
          : 'object' === r && Array.isArray(e)
          ? 'array'
          : 'object' === r && t(e, String, (e, t) => t.isPrototypeOf(e))
          ? 'string'
          : r;
      })(r) === e,
    n = e => t => typeof t === e,
  ...
  const f = (e, t) => ((e, t, r) => '' === t || (e.length >= t.length && e.substr(0, 0 + t.length) === t))(e, t),
    ...
    k = (e, t, r) => ({ major: e, minor: t, patch: r }),
    y = e => {
    ...
    w = () => 'https://cdn.tiny.cloud/1/no-api-key',
    x = e => {
  ...
  const E = e => 1 === (e => e.dom.nodeType)(e),
    ...
    J = h(Array.from) ? Array.from : e => R.call(e),
    W = (e, t) => {
      const r = e.dom;
    ...
    ce = e => {
      ...
      return ae(t, r), (e => e.dom.innerHTML)(t);
    },
    ...
    de = (e, t) => {
      ...
      return ((e, t) => {
        for (let t = 0, s = e.length; t < s; t++)
          if (((n = e[t]), (o = void 0), (o = r), n.dom === o.dom)) return p.some(t);
        var n, o;
        return p.none();
  ...
  var ge = Object.create,
    ...
    we = (e, t) => {
      for (var r in t) ke(e, r, { get: t[r], enumerable: !0 });
    },
    xe = Ce(e => {
    ...
    Ae = Ce(e => {
      ...
      (e.encode = function (e) {
        var r,
          ...
          s = (n = e) < 0 ? 1 + (-n << 1) : 0 + (n << 1);
        do {
          (r = 31 & s), (s >>>= 5) > 0 && (r |= 32), (o += t.encode(r));
        } while (s > 0);
        return o;
      }),
        (e.decode = function (e, r, n) {
          ...
          do {
            ...
            if (-1 === (s = t.decode(e.charCodeAt(r++)))) throw new Error('Invalid base64 digit: ' + e.charAt(r - 1));
            (o = !!(32 & s)), (a += (s &= 31) << l), (l += 5);
          } while (o);
          (n.value = (function (e) {
            var t = e >> 1;
    ...
    Te = Ce(e => {
      ...
      var s = (function (t) {
        ...
        return function (t) {
          for (var s = 0; s < r.length; s++)
            if (r[s].input === t) {
              var i = r[0];
              return (r[0] = r[s]), (r[s] = i), r[0].result;
            }
          var a = (function (t) {
            var r = t,
              s = n(t);
            ...
            return '' === (r = a.join('/')) && (r = i ? '/' : '.'), s ? ((s.path = r), o(s)) : r;
          })(t);
          return r.unshift({ input: t, result: a }), r.length > 32 && r.pop(), a;
        };
      })();
      function i(e, t) {
        '' === e && (e = '.'), '' === t && (t = '.');
      ...
      (e.toSetString = a
        ...
        (e.compareByOriginalPositionsNoSource = function (e, t, r) {
          var n;
          return 0 != (n = e.originalLine - t.originalLine) ||
            0 != (n = e.originalColumn - t.originalColumn) ||
            r ||
            0 != (n = e.generatedColumn - t.generatedColumn) ||
            0 != (n = e.generatedLine - t.generatedLine)
    ...
    Ee = Ce(e => {
      ...
      (o.fromArray = function (e, t) {
        for (var r = new o(), n = 0, s = e.length; n < s; n++) r.add(e[n], t);
        return r;
      }),
        ...
        (o.prototype.add = function (e, o) {
          ...
          (!i || o) && this._array.push(e), i || (n ? this._set.set(e, a) : (this._set[s] = a));
        }),
        ...
        (o.prototype.indexOf = function (e) {
          if (n) {
            ...
            if (r.call(this._set, s)) return this._set[s];
          }
      ...
      (s.prototype._version = 3),
        (s.fromSourceMap = function (e) {
          ...
          return (
            ...
            e.sources.forEach(function (o) {
              var s = o;
              null !== t && (s = r.relative(t, o)), n._sources.has(s) || n._sources.add(s);
        ...
        (s.prototype.applySourceMap = function (e, t, o) {
          ...
          this._mappings.unsortedForEach(function (t) {
            if (t.source === s && null != t.originalLine) {
              var n = e.originalPositionFor({ line: t.originalLine, column: t.originalColumn });
              null != n.source &&
                ((t.source = n.source),
            ...
            e.sources.forEach(function (t) {
              ...
              null != n &&
                (null != o && (t = r.join(o, t)), null != i && (t = r.relative(i, t)), this.setSourceContent(t, n));
            }, this);
        }),
        ...
        (s.prototype._serializeMappings = function () {
          for (
            ...
            if (((e = ''), (n = p[f]).generatedLine !== a)) for (i = 0; n.generatedLine !== a; ) (e += ';'), a++;
            else if (f > 0) {
            ...
            (e += t.encode(n.generatedColumn - i)),
              (i = n.generatedColumn),
              null != n.source &&
                ((s = this._sources.indexOf(n.source)),
                (e += t.encode(s - h)),
                (h = s),
                ...
                (l = n.originalColumn),
                null != n.name && ((o = this._names.indexOf(n.name)), (e += t.encode(o - u)), (u = o))),
              (d += e);
          }
          return d;
        }),
  ...
  function De(e) {
    return Me(e) || 32 === e || 9 === e;
  }
  function Be(e, t) {
    return !(92 !== e || Me(t) || 0 === t);
  }
  function Fe(e, t, r) {
  ...
  for (let e = 0; e < $e.length; e++)
    $e[e] = (De(e) && ze) || (_e(e) && qe) || (Pe(e) && Je) || (Re(e) && We) || e || 128;
  function He(e) {
    return e < 128 ? $e[e] : Je;
  }
  function Ge(e, t) {
  ...
  function rt(e, t) {
    ...
    if (
      ...
      _e(r) && ((t = Ze(e, t + 1)), (r = e.charCodeAt(t))),
      46 === r && _e(e.charCodeAt(t + 1)) && (t = Ze(e, (t += 2))),
      Qe(e, t, 101))
    ) {
      let n = 0;
      (r = e.charCodeAt(t + 1)),
        (45 === r || 43 === r) && ((n = 1), (r = e.charCodeAt(t + 2))),
        _e(r) && (t = Ze(e, t + 1 + n + 1));
    }
    return t;
  }
  ...
  function ot(e) {
    if (1 === e.length && !Ie(e.charCodeAt(0))) return e[0];
    let t = parseInt(e, 16);
  ...
  function at(e) {
    ...
    for (let e = n; e < r; e++) {
      ...
      (o[e] = i),
        (s[e] = a++),
        (10 === n || 13 === n || 12 === n) &&
          (13 === n && e + 1 < r && 10 === t.charCodeAt(e + 1) && (e++, (o[e] = i), (s[e] = a)), i++, (a = 1));
    }
    (o[r] = i), (s[r] = a), (e.lines = o), (e.columns = s), (e.computed = !0);
  }
  var lt = class {
      constructor() {
    ...
    dt = class {
          ...
          this.offsetAndType = null,
            ...
            t(e, (e, t, c) => {
              switch (e) {
                ...
                case i: {
                  let e = a & ct;
                  for (a = o[e], i = a >> ut, o[s] = e, o[e++] = s; e < s; e++) o[e] === r && (o[e] = s);
                  break;
                }
                case 21:
                case 2:
      ...
      lookupValue(e, t) {
        return (
          ...
          Ye(this.source, this.offsetAndType[e - 1] & ct, this.offsetAndType[e] & ct, t)
        );
      }
      getTokenStart(e) {
        return e === this.tokenIndex
          ...
          : e > 0
          ? e < this.tokenCount
            ? this.offsetAndType[e - 1] & ct
            : this.offsetAndType[this.tokenCount] & ct
      ...
      skipUntilBalanced(e, t) {
        let r,
          n,
          o = e;
        e: for (; o < this.tokenCount && ((r = this.balance[o]), !(r < e)); o++)
          switch (((n = o > 0 ? this.offsetAndType[o - 1] & ct : this.firstCharOffset), t(this.source.charCodeAt(n)))) {
            case 1:
              break e;
            case 2:
              o++;
      ...
      dump() {
        ...
        return (
          this.forEachToken((t, r, n, o) => {
            e[o] = { idx: o, type: st[t], chunk: this.source.substring(r, n), balance: this.balance[o] };
          }),
          e
        );
      }
  ...
  function pt(e, t) {
                  ...
                  for (i = 7, c = Xe(e, c); c < e.length; c++) {
                    ...
                    switch (He(t)) {
                      ...
                      case ze:
                        return (
                          (c = Xe(e, c)),
                          41 === r(c) || c >= e.length ? void (c < e.length && c++) : ((c = nt(e, c)), void (i = 8))
                        );
                      case 34:
                      case 39:
                      case 40:
                      case We:
                        return (c = nt(e, c)), void (i = 8);
                      case 92:
                        if (Be(t, r(c + 1))) {
                          c = et(e, c) - 1;
                          break;
    ...
    function s(t) {
      for (t || (t = r(c++)), i = 5; c < e.length; c++) {
        let n = e.charCodeAt(c);
        switch (He(n)) {
          case t:
            return void c++;
          case ze:
            if (Me(n)) return (c += Ke(e, c, n)), void (i = 6);
            break;
          case 92:
            if (c === e.length - 1) break;
            let o = r(c + 1);
            Me(o) ? (c += Ke(e, c + 1, o)) : Be(n, o) && (c = et(e, c) - 1);
        }
      }
    }
    let i,
    ...
    for (; c < a; ) {
      ...
      switch (He(a)) {
        ...
        case 34:
          ...
          break;
        case 35:
          je(r(c + 1)) || Be(r(c + 1), r(c + 2)) ? ((i = 4), (c = tt(e, c + 1))) : ((i = 9), c++);
          break;
        case 39:
          s();
          break;
        ...
        case 47:
          42 === r(c + 1)
            ? ((i = 25), (c = e.indexOf('*/', c + 2)), (c = -1 === c ? e.length : c + 2))
            : ((i = 9), c++);
          break;
        case 58:
          (i = 16), c++;
        ...
        case 59:
          ...
          break;
        case 60:
          33 === r(c + 1) && 45 === r(c + 2) && 45 === r(c + 3) ? ((i = 14), (c += 4)) : ((i = 9), c++);
          break;
        case 64:
          Fe(r(c + 1), r(c + 2), r(c + 3)) ? ((i = 3), (c = tt(e, c + 1))) : ((i = 9), c++);
          break;
        case 91:
          (i = 19), c++;
          break;
      ...
      ((e, t, r, n) => {
        if ((t && 'object' == typeof t) || 'function' == typeof t)
          for (let r of be(t))
            !Se.call(e, r) &&
              'default' !== r &&
              ke(e, r, { get: () => t[r], enumerable: !(n = ye(t, r)) || n.enumerable });
        return e;
      })(
        (e => ke(e, '__esModule', { value: !0 }))(
          ke(null != ft ? ge(ve(ft)) : {}, 'default', { value: ft, enumerable: !0 })
        ),
        ft
      )),
    gt = new Set(['Atrule', 'Selector', 'Declaration']),
    kt = {};
  we(kt, { safe: () => wt, spec: () => Ct });
  var yt = (e, t) => {
  ...
  function It(e, t) {
    let r = this.tokenStart + e,
      n = this.charCodeAt(r);
    for ((n === Et || n === Lt) && (t && this.error('Number sign is not allowed'), r++); r < this.tokenEnd; r++)
  ...
  function jt() {
    ...
    if (10 !== r) {
      if (!this.isDelim(Et, e) && !this.isDelim(Lt, e)) return null;
      t = this.isDelim(Et, e) ? Et : Lt;
      do {
        r = this.lookupType(++e);
      } while (13 === r || 25 === r);
      10 !== r && (this.skip(e), Nt.call(this, _t));
    }
    return (
      e > 0 && this.skip(e),
      0 === t &&
        ((r = this.charCodeAt(this.tokenStart)), r !== Et && r !== Lt && this.error('Number sign is expected')),
      Nt.call(this, 0 !== t),
  ...
  function Rt() {
    let e = this.tokenStart,
      t = null,
      r = null;
    if (10 === this.tokenType) Nt.call(this, !1), (r = this.consume(10));
    else if (1 === this.tokenType && this.cmpChar(this.tokenStart, Lt))
      switch (((t = '-1'), Pt.call(this, 1, Ot), this.tokenEnd - this.tokenStart)) {
        case 2:
          this.next(), (r = jt.call(this));
          break;
        case 3:
          Pt.call(this, 2, Lt), this.next(), this.skipSC(), Nt.call(this, _t), (r = '-' + this.consume(10));
          break;
        default:
          Pt.call(this, 2, Lt), It.call(this, 3, _t), this.next(), (r = this.substrToCursor(e + 2));
      }
    else if (1 === this.tokenType || (this.isDelim(Et) && 1 === this.lookupType(1))) {
      let n = 0;
      switch (
        ((t = '1'), this.isDelim(Et) && ((n = 1), this.next()), Pt.call(this, 0, Ot), this.tokenEnd - this.tokenStart)
      ) {
        case 1:
          this.next(), (r = jt.call(this));
          break;
        case 2:
          Pt.call(this, 1, Lt), this.next(), this.skipSC(), Nt.call(this, _t), (r = '-' + this.consume(10));
          break;
        default:
          Pt.call(this, 1, Lt), It.call(this, 2, _t), this.next(), (r = this.substrToCursor(e + n + 1));
      }
      ...
      s === this.tokenStart + o && this.error('Integer is expected', this.tokenStart + o),
        ...
        s + 1 === this.tokenEnd
          ? (this.next(), (r = jt.call(this)))
          : (Pt.call(this, s - this.tokenStart + 1, Lt),
            s + 2 === this.tokenEnd
              ? (this.next(), this.skipSC(), Nt.call(this, _t), (r = '-' + this.consume(10)))
              : (It.call(this, s - this.tokenStart + 2, _t), this.next(), (r = this.substrToCursor(s + 1))));
    } else this.error();
    return (
      null !== t && t.charCodeAt(0) === Et && (t = t.substr(1)),
  ...
  function Jt() {
    ...
    let e = this.tokenStart,
      t = !1;
    return (
      this.isDelim(Ut) ? ((t = !0), this.next()) : this.isDelim(zt) || this.eat(1),
      this.isDelim(zt)
        ? this.charCodeAt(this.tokenStart + 1) !== Vt
  ...
  function Wt() {
    ...
    return (
      ...
      this.next(),
      t !== Vt && (this.isDelim(Vt) || this.error('Equal sign is expected'), this.next()),
  ...
  function Ht() {
    ...
    return (
      ...
      this.eat(20),
      { type: 'AttributeSelector', loc: this.getLocation(t, this.tokenStart), name: e, matcher: r, value: n, flags: o }
    );
  }
  function Gt(e) {
    this.token(9, '['),
  ...
  function hr() {
    let e = this.tokenStart;
    return (
      this.eat(4), { type: 'IdSelector', loc: this.getLocation(e, this.tokenStart), name: this.substrToCursor(e + 1) }
    );
  }
  function dr(e) {
    this.token(9, '#' + e.name);
  ...
  function yr() {
    ...
    return (
      ...
      { type: 'Nth', loc: this.getLocation(t, r), nth: e, selector: n }
    );
  }
  function br(e) {
      ...
      2 === this.tokenType
        ? ((e = this.consumeFunctionName()),
          ...
          hasOwnProperty.call(this.pseudo, t)
            ? (this.skipSC(), (n = this.pseudo[t].call(this)), this.skipSC())
            : ((n = this.createList()), n.push(this.Raw(this.tokenIndex, null, !1))),
          this.eat(22))
        : (e = this.consume(1)),
      { type: 'PseudoClassSelector', loc: this.getLocation(r, this.tokenStart), name: e, children: n }
    );
  }
  function Tr(e) {
    this.token(16, ':'),
    ...
    return (
      ...
      2 === this.tokenType
        ? ((e = this.consumeFunctionName()),
          ...
          this.eat(22))
        : (e = this.consume(1)),
      { type: 'PseudoElementSelector', loc: this.getLocation(r, this.tokenStart), name: e, children: n }
    );
  }
  function Lr(e) {
    this.token(16, ':'),
  ...
  function Vr(e) {
    ...
    for (let r = n; r <= o; r++) {
      ...
      if (n === Br) {
        ...
        if (((n = e.charCodeAt(++r)), Be(Br, n))) {
          let t = r - 1,
            n = et(e, t);
          (r = n - 1), (s += ot(e.substring(t + 1, n)));
  ...
  function $r() {
    return { type: 'String', loc: this.getLocation(this.tokenStart, this.tokenEnd), value: Vr(this.consume(5)) };
  }
  function zr(e) {
    this.token(
      5,
        ...
        for (let t = 0; t < e.length; t++) {
          ...
          0 !== s
            ? s <= 31 || 127 === s
              ...
              : s === r || s === Br
              ? ((n += '\\' + e.charAt(t)), (o = !1))
              : (o && (Ie(s) || De(s)) && (n += ' '), (n += e.charAt(t)), (o = !1))
            : (n += '\ufffd');
        }
        return '"' + n + '"';
      })(e.value)
  ...
  var Jr = 42;
  function Wr() {
    1 !== this.tokenType && !1 === this.isDelim(Jr) && this.error('Identifier or asterisk is expected'), this.next();
  }
  function Hr() {
    let e = this.tokenStart;
    return (
      this.isDelim(124)
        ? (this.next(), Wr.call(this))
        : (Wr.call(this), this.isDelim(124) && (this.next(), Wr.call(this))),
      ...
      (function (e) {
        ...
        for (let n = 0; n < e.length; n++) {
          ...
          0 !== o
            ? o <= 31 || 127 === o
              ? ((t += '\\' + o.toString(16)), (r = !0))
              : o === Qr || o === Yr || o === Xr || o === Zr || o === en || o === tn
              ? ((t += '\\' + e.charAt(n)), (r = !1))
              : (r && Ie(o) && (t += ' '), (t += e.charAt(n)), (r = !1))
            : (t += '\ufffd');
        }
        return 'url(' + t + ')';
      })(e.value)
  ...
  var sn = (function (e) {
      ...
      return function (e, r) {
        ...
        r &&
          ('function' == typeof r.decorator && (s = r.decorator(s)),
          r.sourceMap &&
            (s = (function (e) {
              ...
              e.node = function (e) {
                if (e.loc && e.loc.start && gt.has(e.type)) {
                  ...
                  (n.line !== c || n.column !== u) &&
                    ...
                    (r.line = i),
                    (r.column = a),
                    l && ((l = !1), (r.line !== o.line || r.column !== o.column) && t.addMapping(s)),
                    (l = !0),
                    t.addMapping({ source: e.loc.source, original: n, generated: r }));
                }
                c.call(this, e), l && gt.has(e.type) && ((o.line = i), (o.column = a));
              };
              let u = e.emit;
              e.emit = function (e, t, r) {
                for (let t = 0; t < e.length; t++) 10 === e.charCodeAt(t) ? (i++, (a = 0)) : a++;
                u(e, t, r);
              };
              let h = e.result;
              return (
                (e.result = function () {
                  return l && t.addMapping(s), { css: h(), map: t };
                }),
                e
              );
            })(s)),
          r.mode in kt && (s.tokenBefore = kt[r.mode]));
        let i = { node: e => s.node(e), children: xt, token: (e, t) => s.token(e, t), tokenize: At };
    ...
    ln = class {
      ...
      allocateCursor(e, t) {
        ...
        return (
          null !== an
            ? ((r = an), (an = an.cursor), (r.prev = e), (r.next = t), (r.cursor = this.cursor))
            : (r = { prev: e, next: t, cursor: this.cursor }),
          (this.cursor = r),
          r
        );
      }
      releaseCursor() {
        let { cursor: e } = this;
        (this.cursor = e.cursor), (e.prev = null), (e.next = null), (e.cursor = an), (an = e);
      }
      ...
      *[Symbol.iterator]() {
      ...
      reduce(e, t, r = this) {
        let n,
          ...
          s = t;
        for (; null !== o.next; ) (n = o.next), (o.next = n.next), (s = e.call(r, s, n.data, n, this));
      ...
      reduceRight(e, t, r = this) {
        let n,
          ...
          s = t;
        for (; null !== o.prev; ) (n = o.prev), (o.prev = n.prev), (s = e.call(r, s, n.data, n, this));
        return this.releaseCursor(), s;
      }
      some(e, t = this) {
  ...
  function dn({ source: e, line: t, column: r }, n) {
    function o(e, t) {
      return s
        .slice(e, t)
        .map((t, r) => String(e + r + 1).padStart(l) + ' |' + t)
        .join('\n');
    }
    let s = e.split(/\r\n?|\n|\f/),
      i = Math.max(1, t - n) - 1,
      ...
      c = 0;
    (r += (hn.length - 1) * (s[t - 1].substr(0, r - 1).match(/\t/g) || []).length) > cn &&
      ((c = r - un + 3), (r = un - 2));
    for (let e = i; e <= a; e++)
      e >= 0 &&
        e < s.length &&
        ((s[e] = s[e].replace(/\t/g, hn)),
        (s[e] =
          (c > 0 && s[e].length > c ? '\u2026' : '') +
          s[e].substr(c, cn - 2) +
          (s[e].length > c + cn - 1 ? '\u2026' : '')));
  ...
  function pn(e, t, r, n, o) {
    return Object.assign(
      ...
      })('SyntaxError', e),
      {
        ...
        line: n,
        column: o,
        sourceFragment: e => dn({ source: t, line: n, column: o }, isNaN(e) ? 0 : e),
        get formattedMessage() {
          return `Parse error: ${e}\n` + dn({ source: t, line: n, column: o }, 2);
        }
      }
    );
  }
  ...
  var xn = (function (e) {
            ...
            getLocationFromList(e) {
              if (n) {
                ...
                return i.getLocationRange(
                  ...
                  null !== n ? n.loc.end.offset - i.startOffset : this.tokenStart,
                  r
                );
              }
              return null;
      ...
      return Object.assign(
        ...
        { SyntaxError: pn, config: a.config }
      );
    })({
      ...
      return (
        e.children.forEach(e => {
          switch (e.type) {
                ...
                case 'host':
                  if (((t.b += 1), e.children)) {
                    ...
                    e.children.first.children.forEach(
                      e => !n && ('Combinator' === e.type ? ((n = !0), !1) : void r.children.push(e))
                    );
                    let o = jn(r)[0];
            ...
            case 'TypeSelector':
              let r = e.name;
              r.includes('|') && (r = r.split('|')[1]), '*' !== r && (t.c += 1);
          }
        }),
        new Rn(t, e)
      );
    ...
    jn = e => {
      ...
      let t = (e => {
        if ('string' == typeof e || e instanceof String)
          try {
            return xn(e, { context: 'selectorList' });
          } catch (t) {
        ...
        if (e instanceof Object) {
          ...
          if (e.type && 'Raw' === e.type)
            try {
              return xn(e.value, { context: 'selectorList' });
            } catch (e) {
      ...
      if ('Selector' === t.type) return [Pn(e)];
  ...
  const Mn = e => {
    ...
    Bn = e => ({ selector: e.selectorText, styles: Dn(e.style) }),
    Fn = e => {
      const t = e.cssRules;
      return q(t, e =>
    ...
    Vn = (e, t, r) => {
      ...
      ((e, t, r) => {
        ...
        r && U(n, e => ('class', void e.dom.removeAttribute('class')));
      })(t, n, r);
    };
  const $n = e => {
      return (
    ...
    zn =
      ...
      (e, t, r) =>
        ((e, t, n, o) => {
          const s = ((e, t) => V(e, e => f(e.selector, t)))($n(t), r);
          Vn(s, n, true);
        })(0, e, t));
  const qn = e => (E(e) ? e : G(e).fold(() => e, qn)),
    Jn = (e, t) => {
      const r = e.parser.parse(t, { isRootContent: !0, forced_root_block: !1 }),
        n = tinymce.html.Serializer({ validate: !0 }, e.schema).serialize(r),
    ...
    Yn = (e, t) => {
      if (C(e)) {
        ...
        const n = e.getDoc(),
          o = T(n);
        zn(o, r, '.ephox-summary-card');
        const s = ((e, t) => {
          const r = void 0 === t ? document : t.dom;
          return (1 !== (n = r).nodeType && 9 !== n.nodeType && 11 !== n.nodeType) || 0 === n.childElementCount
            ? []
            : F(r.querySelectorAll(e), T);
          var n;
        })('*[style]', r);
        return (
          U(s, e => {
    ...
    Xn = (e, t, r) =>
      ((e, t, r) => {
        const n = A('div'),
          ...
          s = Gn(o)
            ? o
            : (e => ((Wn(e) || Hn(e)) && oe(e, 'width', '100%'), Hn(e) && oe(e, 'min-width', '100px'), e))(o);
        return (
          ae(n, s), oe(n, 'max-width', r + 'px'), re(n, 'data-ephox-embed-iri', e), re(n, 'contentEditable', !1), n
        );
      })(e, t, r),
    ...
    so = e =>
      no(e.dom) &&
      (e => {
        return z((e => (e ? J(e.querySelectorAll('*')) : []))(e), ((t = oo), e => !t(e))).isNone();
        var t;
      })(e.dom),
    io = e => /^https?:\/\/\S+$/i.test(e.trim()),
    ao = e => p.from(e).filter(so).map(me).filter(io),
    lo = (e, t, r, n) => {
      const o = ((s = T(e.newBlock)), p.from(s.dom.previousSibling).map(T));
      var s;
      o.filter(E)
        .bind(ao)
        .map(e => {
          r.getAndHandleResponse(
            e,
            r => {
    ...
    co = e => {
      U(e, e => {
        ...
        t.attr('class', 'mce-shim'), t.attr('data-mce-bogus', '1'), e.append(t), e.attr('contenteditable', 'false');
      });
    },
    uo = e => {
      U(e, e => {
    ...
    po = [
      ...
      { code: 600, message: 'The specified service did not respond correctly.' },
      { code: 601, message: 'The specified service did not respond correctly.' }
    ],
    fo = (e, t) =>
      z(po, e => e.code === t).fold(
        () => "Server didn't produce a valid result. (" + t + ')',
        e => e.message
      ),
    mo = e => {
      const t = t => t(e),
    ...
    ko = { value: mo, error: go, fromOption: (e, t) => e.fold(() => go(t), mo) };
  var yo;
  !(function (e) {
    (e[(e.Error = 0)] = 'Error'), (e[(e.Value = 1)] = 'Value');
  })(yo || (yo = {}));
  const bo = (e, t, r) => (e.stype === yo.Error ? t(e.serror) : r(e.svalue)),
    vo = e => ({ stype: yo.Value, svalue: e }),
    So = e => ({ stype: yo.Error, serror: e }),
    Co = bo,
    wo = e => (s(e) && Y(e).length > 100 ? ' removed due to size' : JSON.stringify(e, null, 2)),
    xo = (e, t) => So([{ path: e, getErrorInfo: t }]),
    Ao =
      ((To = (e, t) => (i(e) && i(t) ? Ao(e, t) : t)),
      (...e) => {
        if (0 === e.length) throw new Error("Can't merge zero objects");
        const t = {};
        for (let r = 0; r < e.length; r++) {
          const n = e[r];
          for (const e in n) te(n, e) && (t[e] = To(t[e], n[e]));
        }
        return t;
      });
  var To;
  const Eo = (e, t, r) => {
    ...
    Lo = e => ({
      extract: (t, r) => {
        return (n = e(r)), (o = e => ((e, t) => xo(e, _(t)))(t, e)), n.stype === yo.Error ? o(n.serror) : n;
        var n, o;
      },
      toString: _('val')
    }),
        ...
        i = e =>
          e.fold(
            ...
            e => {
              ...
              return (s = r), (i = p.some), s.stype === yo.Value ? { stype: yo.Value, svalue: i(s.svalue) } : s;
              var s, i;
            }
          );
      switch (e.tag) {
        case 'required':
          return ((e, t, r, n) =>
            ee(t, r).fold(
              () =>
                ((e, t, r) => xo(e, () => 'Could not find valid *required* value for "' + t + '" in ' + wo(r)))(
                  e,
                  r,
                  t
                ),
    ...
    Po = (e, t, r) => {
      return (
        (n = ((e, t, r) =>
          ((e, t) => (e.stype === yo.Error ? { stype: yo.Error, serror: t(e.serror) } : e))(t.extract([e], r), e => ({
            input: r,
            errors: e
          })))(e, t, r)),
    ...
    jo = e =>
      ...
      (e => {
        const t =
          e.length > 10
            ? e.slice(0, 10).concat([{ path: [], getErrorInfo: _('... (only showing first ten failures)') }])
            : e;
      ...
      withTimeout: (t, r) =>
        Vo(
          Fo(n => {
            ...
            e.get(e => {
              o || (clearTimeout(s), n(e));
            });
          })
        )
    }),
    $o = e => Vo(Fo(e)),
    zo = e => Vo(Uo(ko.value(e))),
    qo = {
      nu: $o,
      wrap: Vo,
      pure: zo,
  ...
  const Ho = e =>
        ...
        .map(t => {
          const r = ((e, t) => {
              ...
              return (
                Z(e, (e, t) => {
                  var n;
                  r.push(((n = e), encodeURIComponent(t) + '=' + encodeURIComponent(n)));
                }),
                r
              );
            })(t),
    ...
    Xo = e =>
      qo.nu(t => {
        ...
        r.open(e.method, Yo(e.url, p.from(e.query)), !0);
        const n = (e => {
          const t =
            ((r = e.body),
            p.from(r).bind(e => {
        ...
        const o = () => {
          ((e, t, r) =>
            ...
            })(t, r).map(t => ({ message: Qo(e, r), status: r.status, responseText: t })))(
            e.url,
            e.responseType,
            r
          ).get(e => t(ko.error(e)));
        ...
        (r.onerror = o),
          (r.onload = () => {
            0 !== r.status || f(e.url, 'file:')
              ? r.status < 100 || r.status >= 400
                ? o()
                : ((e, t) => {
                    const r = e => qo.error({ message: e, status: t.status, responseText: t.responseText });
                    switch (e) {
                      case Wo.JSON:
          ...
          p.from(s).map(e =>
            e.type === Wo.JSON
              ...
              : e.type === Wo.FormData || e.type === Wo.MultipartFormData
              ? (e => {
    ...
    es = (e, t, r = Zo) => {
      const n = (e =>
        ee(e, 'tiny-api-key')
          .orThunk(() => ee(e, 'tinymce-api-key'))
          .orThunk(() => ee(e, 'textbox-api-key'))
          .getOrUndefined())(t);
      return {
        execute: o => {
          const s =
          ...
          const a = ((e, t) => {
            ...
            c = ((h = { url: a, responseType: Wo.JSON, credentials: !0, headers: t }),
            Xo({ ...h, method: 'get', body: { type: Wo.Text, data: '' } })).mapError(r);
          var u, h;
          return qo.wrap(c);
        },
        cancelCurrent: O
    ...
    U(e, (n, o) => {
      ...
      t.push(i),
        (r[i] = (...r) => {
          ...
          if (n !== l.length)
            throw new Error(
              'Wrong number of arguments to case ' + i + '. Expected ' + l.length + ' (' + l + '), got ' + n
            );
          return {
            fold: (...t) => {
            ...
            match: e => {
              ...
              if (
                !((e, t) => {
                  for (let t = 0, o = e.length; t < o; ++t) if (!0 !== ((r = e[t]), B(n, r))) return !1;
                  var r;
                  return !0;
                })(t)
              )
  ...
  const ts = _(Oo),
    rs = (e, t, r, n) => ({ tag: 'field', key: e, newKey: t, presence: r, prop: n }),
    ns = e => rs(e, e, { tag: 'required', process: {} }, ts()),
    os = 'iframely',
    ss = 'oembed',
    is = 'fallback',
    as = 'wikipedia',
    ...
    us = (e, t, r) =>
      ((t, r) => {
        for (let r = 0, o = t.length; r < o; r++) if (((n = t[r]), B(e, n))) return !0;
        var n;
        return !1;
      })(t)
        ? ko.error('Embed response source: ' + ls(e) + ' contains more than one of ' + ls(cs))
        : ko.value(r),
    hs = No([
      ns('url'),
      ns('maxWidth'),
      ((e, t) => rs(e, e, { tag: 'defaultedThunk', process: _(!1) }, ts()))('fresh')
    ]),
    ds = No([ns('status_code'), ns('sub_code'), ns('msg')]),
    ps = No([
      ns('html'),
      ((fs = 'rels'),
      (ms = [
            ...
            a(e)
              ? (e =>
                  B(e, os)
                    ...
                    : B(e, as)
                    ? us(e, [os, ss, is], as)
                    : ko.error('Embed response source: ' + ls(e) + ' did not contain any of: ' + ls(cs)))(e)
              : ko.error('Sources was not an array: ' + e)),
          Lo(e => gs(e).fold(So, vo)))
        )
      ]),
      rs(fs, fs, { tag: 'required', process: {} }, No(ms)))
    ]);
  var fs,
    ms,
    gs,
    ks = e =>
      Po('EmbedResponse.failure', ds, e).fold(
        e => ko.error({ code: _(600), subcode: _(0), msg: () => jo(e) }),
        e => ko.error({ code: _(e.status_code), subcode: _(e.sub_code), msg: _(e.msg) })
      ),
    ys = e =>
      Po('EmbedResponse.success', ps, e).fold(
        e => ko.error({ code: _(601), subcode: _(0), msg: () => jo(e) }),
        e => ko.value({ recommended: () => ({ html: _(e.html), source: _(e.rels.source) }) })
      );
  const bs = (e, t, r) => {
      const n = ((e, t = 36e5) => {
          const r = {},
            n = (e, t, n) => {
              r[e] = { result: t, timestamp: n };
            },
            o = (e, r) => e - r < t,
            i = _(r);
          return (
        ...
        o = es(e + '/1/embed?url=${url}&maxWidth=${maxWidth}', t);
      return {
        checkOne: (e, t, r = !1) => {
          const s = Jo(),
            i = ((r, n, s, i, a) =>
              (a ? p.none() : n.get(i, s)).fold(
                () =>
                  ((r, n) => {
                    const s = { url: encodeURIComponent(e), maxWidth: t, fresh: n },
                      i =
                        ((a = 'ephox.media.service.one.ajax.service.get'),
                        (l = hs),
                        (c = s),
                        Po(a, l, c).fold(e => {
                    ...
                    var a, l, c;
                    return o.execute(i);
                  })(0, a).mapResult(e => (n.set(s, e, i), e)),
                e => qo.pure(e)
              ))(0, n, t + '&' + e, s, r);
          return qo.wrap(i.map(e => e.fold(ks, ys)));
        },
        dumpCache: n.dump
      };
    },
    vs = (e, t) => {
      ((e, t) => {
        ...
        r('mediaembed_content_css', { processor: 'string', default: t + '/content.min.css' }),
          r('mediaembed_max_width', { processor: 'number', default: 650 }),
          r('mediaembed_inline_styles', { processor: 'boolean', default: !1 }),
          r('mediaembed_service_url', { processor: 'string', default: '' }),
          r('mediaembed_api_key', { processor: 'string' });
      })(e, t);
      const r = (e => {
          let t;
          const r = t => {
            const r = (e => {
              if ('string' == typeof e) return { message: e };
              {
                const t = e.code();
                return { message: fo(e.msg(), t), code: t };
              }
            })(t);
            ((e, t) => {
      ...
      (e => {
        e.on('click keyup touchend', () => {
          ...
          t &&
            e.dom.getAttrib(t, 'data-ephox-embed-iri') &&
        ...
        (e => {
          ...
          e.on('PreInit', () => {
            ...
            tinymce.Resource.has(r)
              ? e.dom.styleSheetLoader.loadRawCss(r, tinymce.Resource.get(r))
        ...
        e.on('SkinLoaded', () => {
          w(e).length > 0
                        ...
                        new Promise((o, s) => {
                          io(n.url) || o({ html: '' }),
                            t.getAndHandleResponse(
                              ...
                              e => {
                                r.logDialogError(e), s({ msg: r.formatMessage(e.msg(), e.code()) });
                              }
                            );
                        })
                    )(e, t, r)
            ...
            : r.logError('You need to specify the mediaembed_service_url setting');
        });
    };
    ...
    ((e, t) =>
      ...
      -1 ===
        ((e, t) => {
          ...
          return 0 !== o ? o : 0;
        })((e => y((e => [e.majorVersion, e.minorVersion].join('.').split('.').slice(0, 3).join('.'))(e)))(e), y(t)))(
      tinymce,
      '7.0.0'
    )
      ? console.error('The mediaembed plugin requires at least version 7.0.0 of TinyMCE.')
      : vs(e, t);
  });
})();
